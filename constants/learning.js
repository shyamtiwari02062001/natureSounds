...
const LearningMaterial={0:{0:["Play Audio",
	"IT IS A CROW",
	"Species",
	"40",
	"Biggest Crow",
...
Corvus imparatus (Me
Corvus mellori (li
Corvus ossifragus (fish crow)`,"Conversation Status",`According to the International Union for Conservation of
...
1:{0:[
	...
	"पूरी दुनिया में",
	"खासियत           ",
	"बेहद बुद्धिमान पक्षी",
	"बारे में",
	`कौवे काले पक्षी हैं जिन्हें उनकी बुद्धिमत्ता और अनुकूलन क्षमता के लिए जाना जाता है, और उनके जोर से, कठोर "कौवे" के लिए। फसलों को नुकसान पहुंचाने के लिए भी उनकी प्रतिष्ठा है; हालाँकि, उनका प्रभाव पहले के विचार से कम हो सकता है।

जीनस कोरवस में कौवे, रावण और किश्ती शामिल हैं। ये पक्षी Corvidae परिवार का हिस्सा हैं, जिसमें जैज़, मैगपीज़ और न्यूट्रैकर्स शामिल हैं।`,
	"आकार",`पीबीएस के अनुसार, कौवे की लगभग 40 प्रजातियां हैं, इसलिए कौवे के कई अलग-अलग आकार हैं। अमेरिकी कौवा लगभग 17.5 इंच (45 सेंटीमीटर) मापता है। मछली का कौवा 19 इंच (48 सेमी) के आसपास मापता है। आम रैवेन बहुत बड़ा है और 27 इंच (69 सेमी) के आसपास है। कौवे का वजन 12 से 57 औंस (337 से 1,625 ग्राम) कहीं भी हो सकता है। रूक कौवे से छोटे होते हैं और अलग-अलग आकार के पूंछ और हल्के रंग के बिल होते हैं। वे औसतन 18 इंच (47 सेमी) लंबे हैं।

अमेरिकी कौवे कई तरह से आम बीहड़ों से भिन्न होते हैं। रेवन्स बड़े होते हैं; उनकी आवाज कर्कश है; मिशिगन विश्वविद्यालय के पशु विविधता वेब (ADW) के अनुसार, उनके पास भारी बिल हैं। रावन्स की पूंछ और पंख एक बिंदु पर आते हैं।`,
	"पर्यावास",`कौवे दुनिया भर में विभिन्न प्रकार के निवास स्थान में पाए जा सकते हैं। उदाहरण के लिए, अमेरिकी कौआ पूरे उत्तरी अमेरिका में रहता है और आसपास के पेड़ों के साथ खुले क्षेत्रों - कृषि भूमि और घास के मैदानों को तरजीह देता है। वे ADW के अनुसार, उपनगरीय इलाकों में भी पनपे।

ADW के अनुसार, सामान्य रैवेन दुनिया भर में सबसे व्यापक पक्षियों में से एक है। वे उत्तरी यूरोप, स्कैंडिनेविया, आइसलैंड और ग्रीनलैंड में पाए जाते हैं; पूरे एशिया में, प्रशांत महासागर से हिमालय तक भारत और ईरान तक; पूरे उत्तरपश्चिमी अफ्रीका और कैनरी द्वीप समूह में; और उत्तरी और मध्य अमेरिका में निकारागुआ जितना दक्षिण में है। वे खुले परिदृश्य पसंद करते हैं, भी - समुद्री तट, बेस्वाद टुंड्रा, चट्टानी चट्टानें, पहाड़ के जंगल, खुले नदी किनारे, मैदान, रेगिस्तान और झाड़ीदार जंगल।

रूक पूरे यूरोप और पश्चिमी एशिया में पाए जाते हैं। वे, व्यापक खुले स्थान, नदी के मैदान और सीढ़ियों को पसंद करते हैं।`,
	"आदत",`कौवे बेहद बुद्धिमान पक्षी हैं। वे अपनी समस्या सुलझाने के कौशल और अद्भुत संचार कौशल के लिए जाने जाते हैं। उदाहरण के लिए, जब एक कौवा एक क्षुद्र मानव का सामना करता है, तो यह अन्य कौवे को सिखाएगा कि मानव की पहचान कैसे करें। वास्तव में, अनुसंधान से पता चलता है कि कौवे एक चेहरा नहीं भूलते।


कई प्रकार के कौवे एकान्त होते हैं, लेकिन वे अक्सर समूहों में चारा डालते हैं। अन्य बड़े समूहों में रहते हैं। कौवे के एक समूह को हत्या कहा जाता है। जब एक कौवा मर जाता है, तो हत्या मृतक को घेर लेगी। यह अंतिम संस्कार सिर्फ मृतकों के लिए शोक करने के लिए नहीं है, हालांकि कौवे एक साथ इकट्ठा होकर यह पता लगाते हैं कि उनके सदस्य ने क्या मारा। फिर, कौवे की हत्या एक साथ बंधेगी और शिकारियों के साथ एक व्यवहार में पीछा करेगी। कुछ कौवा प्रजातियों के साथ, वार्षिक और गैर-संभोग वयस्क एक समूह में रहते हैं जिन्हें एक रोस्टिंग समुदाय कहा जाता है।

कुछ कौवे पलायन करते हैं जबकि अन्य कौवे सामान्य अर्थों में पलायन नहीं करते हैं। वे जरूरत पड़ने पर अपने क्षेत्र के गर्म इलाकों की यात्रा करेंगे।

ADW के अनुसार अमेरिकन कौवे फसलों के लिए हानिकारक हो सकते हैं, लेकिन वे कीटों को खाने से नुकसान को भी रोक सकते हैं। हाल के अध्ययनों से पता चला है कि बदमाशों द्वारा खाए गए 60 से 90 प्रतिशत कीड़े कृषि कीट हैं।

ग्रामीणों के अनुसार, वे मरे हुए जानवरों और कचरे को भी साफ करते हैं। वास्तव में, कचरे के डिब्बे को पलटने के लिए अक्सर कौवे को दोषी ठहराया जाता है; हालांकि, वॉशिंगटन डिपार्टमेंट ऑफ फिश एंड वाइल्डलाइफ के मुताबिक, असली अपराधी आमतौर पर रैकून या कुत्ते होते हैं।`,
	"आहार","कौवे सर्वभक्षी हैं, जिसका अर्थ है कि वे लगभग कुछ भी खाते हैं। कौवे छोटे जानवरों जैसे स्तनधारी, उभयचर, सरीसृप, अंडे और कैरीयन खाते हैं। वे कीड़े, बीज, अनाज, नट, फल, गैर-कीट आर्थ्रोपोड, मोलस्क, कीड़े और यहां तक ​​कि अन्य पक्षियों को भी खाते हैं। ADW के अनुसार, कौवे को कचरा खाने, और भोजन को अल्पावधि में, पेड़ों में या जमीन पर रखने के लिए भी जाना जाता है।",
	"संतान",`कौवे सहकारी प्रजनक हैं, जिसका अर्थ है कि वे अक्सर उस जगह के करीब रहते हैं जहां वे पैदा हुए थे और क्षेत्र की युवा लड़कियों को पालने और बचाव में मदद करते हैं। जब संतान होने का समय होता है, तो एक संभोग जोड़ी शाखाओं, टहनियाँ, बाल, सुतली, छाल, पौधों के तंतुओं, काई, कपड़ा और अन्य सामग्रियों का उपयोग करके जमीन के ऊपर एक घोंसला 15 से 60 फीट (4.5 से 18 मीटर) का निर्माण करेगी। वाशिंगटन डिपार्टमेंट ऑफ फिश एंड वाइल्डलाइफ के अनुसार, घोंसले 1.5 से 2 फीट (46 से 61 सेमी) व्यास के हैं।

मादा चार से पांच अंडे देती है और 18 दिनों के लिए इनक्यूबेट करती है। चार सप्ताह में, चूजे घोंसला छोड़ने में सक्षम होते हैं, हालांकि उनके माता-पिता अभी भी उन्हें तब तक खिलाते हैं जब तक कि वे लगभग 60 दिन के नहीं हो जाते। कौवे 14 साल तक जीवित रह सकते हैं।`,
	"वर्गीकरण / वर्गीकरण",`एकीकृत कर सूचना प्रणाली (आईटीआईएस) के अनुसार, कौवे की करबद्धता इस प्रकार है:

किंगडम: एनीमलिया सबकिंगडोम: बिलाटेरिया इन्फ्राकिंगडोम: ड्यूटेरोस्टोमिया फाइलम: कोर्डेटा सबफाइलम: वर्टेब्रेटा इंफ्राटाइलम: ग्नथोस्टोमाटा क्लास: एव्स सुपरक्लास: टेट्रापोडा ऑर्डर: पैसीरिफोर्मेस फैमिली: कोर्विडे जीनस: कोरवस प्रजाति: 30 से अधिक हैं

कोर्वस ब्राचिहाइन्चोस (अमेरिकी कौवा)
कोरवस कौरिनस (पश्चिमोत्तर कौआ)
Corvus corax (आम रैवेन)
कोरवस कोरोन (कैरियन क्राउन)
कोरवस कोरोनोइड्स (ऑस्ट्रेलियाई रैवेन)
कोरवस क्रिप्टोलेकस (चिहुआहुआन रैवेन)
कोरवस फ्लोरेंसिस (फ्लोर्स क्रो)
कॉरवस फ्रुगिलगस (किश्ती)
कोरवस हौवाइनेसिस ('अलाला, हवाई कौवा)
कोरवस इम्पोर्टर (मैक्सिकन क्रो)
कोरव्स मेलोरी (थोड़ा रैवेन)
